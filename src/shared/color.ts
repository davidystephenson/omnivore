...
export const LIGHT_GREEN: Rgb = { red: 0, green: 192, label: 'light green', blue: 0 }
...
export const PINK: Rgb = { red: 192, green: 128, label: 'pink', blue: 154 } // tardigrade
...
export const YELLOW: Rgb = { red: 192, green: 150, label: 'yellow', blue: 0 } // fly
export const COLOR = {
  BLACK,
  BLUE,
  BROWN,
