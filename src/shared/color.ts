...
export const GRAY: Rgb = { red: 96, green: 96, label: 'gray', blue: 96 } // whale
...
export const LIGHT_GRAY: Rgb = { red: 160, green: 160, label: 'light gray', blue: 160 }
export const LIGHT_GREEN: Rgb = { red: 0, green: 148, label: 'light green', blue: 0 }
...
export const LIGHT_PINK: Rgb = { red: 255, green: 192, label: 'pink', blue: 224 }
...
export const LIGHT_YELLOW: Rgb = { red: 255, green: 224, label: 'light yellow', blue: 0 }
...
export const ORANGE: Rgb = { red: 255, green: 96, label: 'orange', blue: 0 } // crow
export const LIGHT_ORANGE: Rgb = { red: 255, green: 192, label: 'light orange', blue: 128 }
export const PINK: Rgb = { red: 255, green: 128, label: 'pink', blue: 192 } // tardigrade
export const PURPLE: Rgb = { red: 128, green: 0, label: 'purple', blue: 128 } // boa
export const RED: Rgb = { red: 192, green: 0, label: 'red', blue: 0 } // tiger
export const WHITE: Rgb = { red: 255, green: 255, label: 'white', blue: 255 } // debug
export const YELLOW: Rgb = { red: 192, green: 148, label: 'yellow', blue: 0 } // fly
export const COLOR = {
  BLACK,
  BLUE,
  BROWN,
